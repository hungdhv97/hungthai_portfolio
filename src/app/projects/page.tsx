...
const projectsPage = () => {
    const projects = [
        ...
        },
        {
            ...
            description:
                "Patrick Portfolio is a personal portfolio website showcasing a developer's skills, projects, and experiences. " +
                "Built with Next.js and TypeScript, the site features a clean and modern design using Shadcn UI components. " +
                "The portfolio is designed to be responsive and user-friendly, making it easy for potential employers and collaborators to explore the developer's work.",
        ...
        },
        {
            ...
            description:
                "HH Story is a backend service and admin panel for a website dedicated to reading and managing stories. " +
                "It is built with Django, utilizing Scrapy for web scraping and Celery for task management. " +
                "The platform enables efficient management of large volumes of stories, providing administrators with the tools they need to maintain and update content effortlessly.",
        ...
        },
        {
            ...
            description:
                "The HH Story Frontend is the user-facing part of a story reading website, designed with Next.js and styled using TailwindCSS and Shadcn UI. " +
                "The frontend is optimized for performance and accessibility, providing a seamless reading experience for users. " +
                "It is fully responsive, ensuring that the website looks great and functions well on all devices.",
        ...
        },
        {
            ...
            description:
                "The Crypto Airdrop Tool is an automation tool designed to simplify the process of participating in cryptocurrency airdrops. " +
                "Developed with C# and Selenium, it automates the tedious tasks involved in claiming airdrops, saving users time and effort. " +
                "The tool is user-friendly and can handle multiple airdrops simultaneously, making it a valuable asset for crypto enthusiasts.",
            tags: ["C#", "Selenium"],
        ...
        },
        {
            ...
            description:
                "The Covid-19 Tracking App is a real-time website designed to track Covid-19 cases across different regions. " +
                "Built with React.js and JavaScript, the app fetches and displays the latest data on Covid-19 cases, recoveries, and deaths. " +
                "The application features an intuitive interface, making it easy for users to stay informed about the pandemic's progress in their area.",
        ...
        },
        {
            ...
            tags: ["Python", "JupyterNotebook", "AIModel"],
            link: "https://github.com/hungdhv97/Virtual-Assistant",
        },
        {
            title: "Tetris Game - A simple yet engaging Tetris game",
            description:
                "This Tetris Game is a Java-based application that brings the classic Tetris experience to modern platforms. " +
                "The game features smooth gameplay and intuitive controls, offering players of all ages an enjoyable and nostalgic gaming experience. " +
                "The application is lightweight and designed to run efficiently on a wide range of devices.",
            tags: ["Java"],
            link: "https://github.com/hungdhv97/TetrisGame",
        },
        {
            title: "Realtime Face Recognition - AI-driven face recognition tool",
            description:
                "Realtime Face Recognition is an AI-driven tool developed to recognize and track faces in real time using Python and OpenCV. " +
                "The application can be used for security purposes, in smart homes, or as a part of other advanced systems requiring face recognition capabilities. " +
                "It is designed to be fast and accurate, handling multiple faces simultaneously.",
            tags: ["Python", "OpenCV"],
        ...
        },
        {
            ...
            description:
                "The Self Driving Car project is a Python-based simulation that demonstrates the principles of autonomous driving. " +
                "The application models a self-driving car navigating various road conditions and obstacles, showcasing AI's potential in revolutionizing transportation. " +
                "It serves as a valuable learning tool for those interested in autonomous vehicles.",
            tags: ["Python"],
        ...
        },
        {
            ...
            description:
                "Crime Scene is a Unity3D-based project that simulates a 3D crime scene, providing users with an interactive environment to explore and investigate. " +
                "The demo is designed to demonstrate the capabilities of Unity3D in creating realistic simulations for training or entertainment purposes. " +
                "Users can navigate the scene, gather clues, and solve the mystery.",
            tags: ["Unity3D"],
            link: "https://github.com/hungdhv97/Crime-Scene-Demo",
        },
        {
            title: "GLOW-V - Retraining AI model with Vietnamese human faces",
            description:
                "GLOW-V is a project focused on retraining AI models to better generate Vietnamese human faces. " +
                "Utilizing Python and advanced AI models, the project aims to enhance the quality of facial image generation in diverse environments. " +
                "The retrained models are evaluated to ensure they perform well across different demographics, making the technology more inclusive.",
            tags: ["Python", "AIModel"],
